...
input.addEventListener("change", writes);

function writes(evento) {
...
myWebpage.addEventListener("dblclick", goToPort);

function goToPort() {
    console.log("oi")
 window.open("danubiorafa.github.io", "_blank");
}

// 5. Crie uma função que, ao passar o mouse sobre 'Meu top 3 do Spotrybefy', altere
// a cor do mesmo;

myWebpage.addEventListener("mouseover", changesColor);

function changesColor(evento) {
